...
####
    ...
    result.append(['tvn','','','http://rominc.synology.me:9999/klive/api/url.m3u8?m=url&s=tving&i=C01141&q=default&apikey=DOR0RCDXSE',''])
    result.append(['xtvn','','','http://rominc.synology.me:9999/klive/api/url.m3u8?m=url&s=tving&i=C00551&q=default&apikey=DOR0RCDXSE',''])
