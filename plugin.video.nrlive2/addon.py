...
##    items2.append({'label':fixed[3][0], 'path':plugin.url_for('LiveTVplayfixed', title='SPOTV On 2',cid='http://www.jnas.info:9999/command/api/execute?apikey=0220169BZA&id=2&mode=redirect&ch=spotvnow2'), 'thumbnail':fixed[3][1]})
    items2.append({'label':'SPOTV', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/91?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
    items2.append({'label':'SPOTV2', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV2',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/92?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
    items2.append({'label':'SPOTV ON', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV On',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/97?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
    items2.append({'label':'SPOTV On 2', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV On 2',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/96?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
    items2.append({'label':'SPOTV Prime', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV Prime',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/95?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
    items2.append({'label':'SPOTV Golf & Health', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV Golf & Health',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/94?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
    items2.append({'label':'SPOTV NBA', 'path':plugin.url_for('LiveSPOTVplay', title='SPOTV NBA',cid='http://redsdr01.duckdns.org:9981/stream/channelnumber/93?auth=PqUlaWkWJiovaHWv2XUHUz3C0QOU'), 'thumbnail':''})
